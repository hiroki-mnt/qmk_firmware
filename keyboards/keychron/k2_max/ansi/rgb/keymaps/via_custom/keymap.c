...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
     KC_TAB,   KC_Q,     MT(MOD_LGUI,KC_W),  KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     MT(MOD_RGUI,KC_O),     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
     KC_LCTL,  KC_A,     KC_S,     KC_D,     MT(MOD_LALT,KC_F),  KC_G,     KC_H,     MT(MOD_RALT,KC_J),     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            MT(MOD_RCTL,KC_ENT),             KC_HOME,
     MT(MOD_LSFT,KC_LNG2),  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  MT(MOD_LSFT,KC_LNG1),  KC_UP,    KC_END,
     KC_LCTL,  KC_LGUI,  KC_LALT,                                LT(WIN_SPACE_LAYER, KC_SPC),                                 KC_RALT, MO(WIN_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[WIN_SPACE_LAYER] = LAYOUT_ansi_84(
     ...
     _______,            _______,  _______,  _______,  _______,  KC_BSPC,  KC_PGDN,  KC_APP,  _______,  _______,  _______,            _______,  _______,  _______,
     _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______),
...
[WIN_ALT_LAYER] = LAYOUT_ansi_84(
    ...
    _______,  _______, S(KC_TAB), KC_DOWN,  KC_TAB,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,
    _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,
    _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______),
